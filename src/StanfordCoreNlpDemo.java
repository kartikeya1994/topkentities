...
public class StanfordCoreNlpDemo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length > 0) {
      ...
      annotation = new Annotation("the contradiction between iraqi diplomatic moves and stance of president remains puzzling at the same time to the united states");
    }
